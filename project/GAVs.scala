...
object GAVs {
  ...
  object A {
    ...
    lazy val circeTestingA: String           = "circe-testing"
    lazy val disciplineMunitA: String        = "discipline-munit"
    lazy val errors4sCoreA: String           = "errors4s-core"
    lazy val errors4sCoreCatsA: String       = "errors4s-core-cats"
    lazy val errors4sCoreScalacheckA: String = "errors4s-core-scalacheck"
  ...
  object V {
    ...
    lazy val errors4sCoreCatsV: String       = "1.0.0.0-RC0"
    lazy val errors4sCoreScalacheckV: String = "1.0.0.0-RC0"
    lazy val errors4sCoreV: String           = "1.0.0.0-RC0"
